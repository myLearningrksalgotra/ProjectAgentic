...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-Bcd_Tkvz.js';
import Example from './Example6-1FHoJIeF.js';
...
const lang_map = {
  python: () => import('./index32-DX5eFh6Y.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-PP5ZXbGq.js'),
      import('./frontmatter-CGqmnPqP.js')
    ]);
  ...
  json: () => import('./index37-DqH3mLOE.js').then((m) => m.json()),
  html: () => import('./index34-Xghn-f3B.js').then((m) => m.html()),
  css: () => import('./index35-xoGDAB0d.js').then((m) => m.css()),
  javascript: () => import('./index36-BxK2G4Z3.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-BxK2G4Z3.js').then(
...
//# sourceMappingURL=Index16-CiAqU_Ux.js.map
